        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="rounded-2xl border-none shadow-2xl p-0 overflow-hidden max-w-md">
            <div className="bg-blue-600 p-8 text-white">
              <DialogHeader>
                <DialogTitle className="text-2xl font-black">Create User</DialogTitle>
                <DialogDescription className="text-blue-100 font-medium">Add a new member to your organization</DialogDescription>
              </DialogHeader>
            </div>
            <div className="p-8 space-y-5 bg-white">
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="name" placeholder="John Doe" className="pl-10 rounded-xl border-slate-200 h-11" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" type="email" placeholder="john@example.com" className="pl-10 rounded-xl border-slate-200 h-11" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <select id="role" className="w-full pl-10 pr-4 h-11 bg-white border border-slate-200 rounded-xl appearance-none focus:ring-2 focus:ring-blue-500 outline-none font-medium text-slate-900">
                    <option>admin</option>
